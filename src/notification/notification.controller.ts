...
export class NotificationController {
  ...
  @ApiResponse({ status: 201, description: 'Notification enqueued successfully.' })
  async sendNotification(@Body() createNotificationDto: CreateNotificationDto) {
    await this.notificationQueue.add(NOTIFICATION_JOBS.SEND_NOTIFICATION, createNotificationDto);
